...
latlng: "39.997340, -83.014550"       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use https://www.latlong.net/)
...
instructor: ["Trisha Adamus", Niel Infante] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Steve Chang, Cathie Smith"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["TDAI@osu.edu"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes:  https://pad.carpentries.org/2019-08-26-mbdh           # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
eventbrite: 67799218287   # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
...
Improve your skills with data and the social sciences with this two-day, hands-on training from Data Carpentry. This training focuses the full spectrum of using data for research, including data cleaning, data management, data analysis, and data visualization.

The training teaches students how to use spreadsheets and other openly available data cleaning tools (OpenRefine) to perform data cleaning, management, analysis, and visualization. The training also teaches students how to use the R programming language to accomplish these critical data tasks, and how to use SQL managed their research data. 
{% endcomment %}
...
This training is meant to be useful to students with no previous programming background.
{% endcomment %}
{% if page.carpentry == "swc" %}
{% include sc/who.html %}
{% elsif page.carpentry == "dc" %}
...
https://pad.carpentries.org/2019-08-26-mbdh
